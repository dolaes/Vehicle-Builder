...
class Truck extends Vehicle {
  ...
  // A constructor that accepts the properties of the Truck class
  constructor(
    vin: string,
    color: string,
    make: string,
  ...
  // The tow method from the AbleToTow interface
  ...
  // Override the printDetails method from the Vehicle class for the truck
  override printDetails(): void {
    ...
    console.log(`Tow Capactiy: ${this.towCapacity} lbs`);
